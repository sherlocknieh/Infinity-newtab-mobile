var QC = (function () {
      ...
      (s = { '\b': '\\b', '\t': '\\t', '\n': '\\n', '\f': '\\f', '\r': '\\r', '"': '\\"', '\\': '\\\\' }),
      {
        ...
        parse: function (e) {
          ...
          try {
            ...
            w.error('JSON.parse => parseæ•°æ®æ ¼å¼é”™è¯¯:' + e)
          }
          return t
        }
      })
  ...
  var d,
        ...
        ((XMLDocument.prototype.selectNodes = function (t, e) {
          ...
          for (
            var n = this.createNSResolver(this.documentElement),
              o = this.evaluate(t, e, n, XPathResult.ORDERED_NODE_SNAPSHOT_TYPE, null),
              i = [],
              r = 0;
            r < o.snapshotLength;
            r++
              ...
              (e = s[c]),
                s !== (n = t[c]) &&
                  (r && n && 'object' == typeof n && !n.nodeType
                    ? ((e = e || (n instanceof Array ? [] : 'object' == typeof n ? {} : n)),
    ...
    _ =
      ...
      (i = {
          ...
          if (
            ...
            for (var d = 0, p = r.length; d < p; ++d)
              1 < (a = r[d].split(o)).length
                ? ((s = (s = a.slice(1).join(o).split(n)).slice(n.length, s.length - n.length).join(n)),
        ...
        commonDictionaryJoin: function (t, e, n, o, i) {
          ...
          'string' != typeof o && (o = '='),
          t))
            (r = (t[a] + '').replace(d, '\\"')), s.push(a + o + n + ('function' == typeof i ? i(r) : r) + n)
          return s.join(e)
        }
      }),
      {
    ...
    v =
      ((p = [/&(?!amp;|lt;|gt;|#039;|quot;|#39;)/g, /</g, />/g, /\x27/g, /\x22/g]),
      (u = ['&amp;', '&lt;', '&gt;', '&#039;', '&quot;']),
      {
        escHTML: function (t) {
  ...
  var C,
    C =
          ...
          : document.attachEvent &&
            (document.attachEvent('onreadystatechange', function () {
              ;('complete' !== document.readyState && 'loaded' !== document.readyState) ||
                (document.detachEvent('onreadystatechange', arguments.callee), k())
            }),
              ...
              })())),
      {
        domReady: function (t) {
          'function' == typeof t &&
            (k.fired || 'complete' === document.readyState || 'loaded' === document.readyState
              ? (k(), t())
              : k.list.push(t))
        },
        add: function (t, e, n) {
  ...
  x.send = function (t, e, n) {
    ...
    ;(n = n || {}),
      ...
      (i = e || '/open/connect/error_path'),
      (r = n.referDomain || location.hostname),
      (t = n.referPath || location.pathname),
      (e = Math.random()),
      (n = document.cookie.match(/(?:^|;+|\s+)pgv_pvid=([^;]*)/i)) && n.length && 1 < n.length
        ? (a = n[1])
        : ((a = (Math.round(2147483647 * Math.random()) * new Date().getUTCMilliseconds()) % 1e10),
          (document.cookie =
            'pgv_pvid=' + a + '; path=/; domain=' + location.hostname + '; expires=Sun, 18 Jan 2038 00:00:00 GMT;')),
      ((s = new Image()).onload = s.onerror =
        function () {
          ;(s.onload = s.onerror = null), (s = null)
        }),
      (s.src =
        'https://pingfore.qq.com/pingd?cc=-&ct=-&java=1&lang=-&pf=-&scl=-&scr=-&tt=-&tz=-8&vs=3.3&flash=&dm=' +
        o +
        '&url=' +
        i +
        '&rdm=' +
  ...
  return {
    ...
    reportBNL: function (t, e) {
      ...
      //   'https://cgi.connect.qq.com/report/report?strValue=' + (e = e || 0) + '&nValue=' + t + '&tag=0&t=' + n
    },
    getVersion: function () {
      return '1.0.1'
    }
...
!(function (g) {
  ...
  ~~g.QueryString.getParameter('__qc_wId') ||
    ...
    ((n = +new Date() % 1e3), (document.cookie = ['__qc_wId=' + n, '; path=/'].join(';')))
    ...
    d = {
      ...
      getCrossSolution: function () {
        var t = window.postMessage
          ...
          ? 'FLAProxy'
          : (g.Console.error('æœªæ‰¾åˆ°å¯ç”¨çš„è·¨åŸŸé€šä¿¡æ–¹æ¡ˆ'), 'EMPProxy')
        return g.Console.info('ç¡®å®šè·¨åŸŸä»£ç†ç­–ç•¥ï¼š' + t), t
      }
    },
    p = 1e3
  ...
  ;(u.prototype.success = function (t) {
    ...
    (u.prototype._onCallback = function (t, e, n) {
      ...
      200 == t.status || 204 == t.status
        ? ((o = t.responseText), ~~(o = new l(o, t.status, e, n)).code ? this.onError(o) : this.onSuccess(o))
  ...
  ;(l.prototype.parseData = function (t) {
    ...
    (l[100013] = function (t, e) {
      g.Login.signOut(), g.Console.warn('apiè¿”å›žtokenå¤±æ•ˆ')
    })
  ...
  ;(f.prototype.init = k),
    ...
    (f.prototype.send = function (t) {
      var e
      for (t && this.requests.push(t); this.isReady && (e = this.requests.shift()); )
        f.pendingRequests.push(e),
          QC.Console.log('seq no :' + e.seq + 'è¯·æ±‚å‘èµ·  ts -> ' + +new Date()),
          this._doSend(e)
    }),
    ...
    (f.dispatchReceive = function (t, e, n, o) {
      for (var i = f.pendingRequests, r = 0; r < i.length; r++)
        if (i[r].seq == t)
          return (
            QC.Console.log('seq no :' + t + 'å“åº”æ”¶åˆ°  ts -> ' + +new Date()),
    ...
    (f.invoke =
      ((m = []),
      function (t) {
        if ((t && m.push(t), !b)) return g.Console.info('Proxyæœªåˆå§‹åŒ–ï¼Œinvokeå…¥æ ˆ'), void f.generateProxy()
    ...
    (g._create_fla_proxy = function () {
      ;(g._create_fla_proxy = k),
        document._qc_cross_request_flash_proxy || _('_qc_cross_request_flash_proxy') || new I()
    })
  ...
  g.Object.extend(I.prototype, {
    ...
    init: function () {
      var t,
        ...
        n =
          ...
          t && t[1]
            ...
            ? (n = 1e4 + e)
            : ((n = e), (document.cookie = ['__qc_wId=' + n, '; path=/'].join(';'))),
          g.Console.info('è·¨åŸŸçª—å£æ ‡è¯†å· __qc_wId : ' + n),
          n),
        n = I.getFlashHtml({
          src: d.FLACrossPage,
          width: '100%',
      ...
      ;(i.style.cssText =
        ...
        (window[this.prefix + 'onFlashReady_' + this.timeStamp] = function () {
          g.Console.info('FLAProxyä»£ç†åˆ›å»ºæˆåŠŸï¼Œè€—æ—¶' + (new Date() - o.timeStamp)),
            setTimeout(function () {
    ...
    _doSend: function (t) {
      ...
      t
        ? t(e, n, r, i, o)
        : (function () {
            throw new Error('flash proxy åˆå§‹åŒ–å¤±è´¥')
          })()
    },
    ...
    (I.getFlashHtml = function (t, e, n) {
      ...
      for (o in ((e = e || 9), t))
        switch (o) {
          ...
          case 'src':
            a
              ? r.push('<param name="movie" value="', t.noSrc ? '' : t[o], '"/>')
      ...
      return (
        a
          ? i.push(' classid="clsid:', n || 'D27CDB6E-AE6D-11cf-96B8-444553540000', '"')
          : i.push(' type="application/x-shockwave-flash"'),
        location &&
          location.protocol.indexOf('https') < 0 &&
          i.push(' codeBase="http://fpdownload.macromedia.com/get/flashplayer/current/swflash.cab#version=', e, '"'),
  ...
  g.Object.extend(S.prototype, {
    init: function () {
      ...
      ;(e._connFrame = document.createElement('iframe')),
        (e._connFrame.style.cssText = 'width:0px; height:0px; display:none; overflow:hidden;')
      var t = function () {
        t.fire(), (t.fire = k)
      }
      ;(t.fire = function () {
        g.Console.info('PMProxyä»£ç†åˆ›å»ºæˆåŠŸï¼Œè€—æ—¶' + (new Date() - e.timeStamp)),
          (e.isReady = !0),
          e.send(),
          e.invoke()
      }),
        (e._connFrame.onload = t),
        e._connFrame.addEventListener && e._connFrame.addEventListener('load', t, !1),
    ...
    _doInvoke: function (t) {
      ...
      g.Console.log('invoke:\t' + t),
        'string' == typeof t &&
          ((t = (e = t.split('#'))[0]), (e = e[1] && e[1].split(',')), f.getFunction(t).apply(null, e))
    },
    onDispose: function () {
  ...
  function P(t) {
    ...
    if (R <= 0) throw new Error('æ„å¤–çš„è°ƒç”¨äº†ç»‘å®štokenåˆ°reqçš„æ–¹æ³• bindTokenPara')
    return (
      ...
      0 < R
        ? setTimeout(function () {
            ...
            t.openid && t.accessToken
              ? b.send(P(r))
              : (M.push(r),
                g.Console.log('openidä¸ŽaccessTokenä¸¢å¤±ï¼Œè°ƒç”¨è¯·æ±‚å…¥æ ˆ : [' + e + ']ï¼Œæ ˆå¤§å°ï¼š' + M.length))
          }, 10)
        : (M.push(r),
          g.Console.log(
            (b.isReady && R < 0 ? 'tokenèŽ·å–å¤±è´¥ï¼Œè¯·è°ƒç”¨ç”¨æˆ·ç™»å½•æµç¨‹' : 'apiä»£ç†å°šæœªåˆå§‹åŒ–æˆåŠŸ') +
              'ï¼Œè°ƒç”¨è¯·æ±‚å…¥æ ˆ : [' +
              e +
              ']ï¼Œæ ˆå¤§å°ï¼š' +
              M.length
  ...
  g.api =
    ...
    (j._ready = function () {
      var t
      for (g.Console.info('initæˆåŠŸï¼Œå¼€å§‹è§¦å‘apiè°ƒç”¨å †æ ˆ'); (t = M.shift()); ) b.send(P(t))
    }),
    (j.getDoc =
      ((Q = null),
      function (t, e) {
  ...
  g.Login = (function () {
    ...
    function s(n) {
      ...
      if (o < 0) QC.getAppId(arguments)
        ...
        if (n && n.btnId) {
          if (!t) throw new Error('æœªæ‰¾åˆ°æ’å…¥èŠ‚ç‚¹:')
          ...
          n.showModal
            ? (((c = document.createElement('DIV')).style =
              ...
              (c.innerHTML = '<iframe id="qq_login_iframe" frameborder="0" width="100%" height="100%"></iframe>'),
              (c.style.top = 0),
            ...
            : (t.firstChild.onclick =
                ((a = r),
                window.addEventListener ? window.addEventListener('unload', d, !1) : window.attachEvent('onunload', d),
                function () {
                  return (
                    s && s.close(), (s = a()), g._create_fla_proxy(), QC.pv('graph.qq.com', '/open/connect/click'), !1
                  )
                }))
        }
      }
    ...
    ;(s.TEMPLATE = ['<a href="javascript:;" onclick="{onclick};"><img src="{src}" alt="{alt}" border="0"/></a>'].join(
      ''
    )),
      ...
      (s._getPopupUrl = function (t) {
        ...
        return (
          e && t.push('scope=' + e),
          n && (0 < n.indexOf('://') && (n = encodeURIComponent(n)), t.push('redirect_uri=' + n)),
          ...
          ? h(function (t) {
              t
                ? QC.api('get_user_info')
                    ...
                    .error(function (t) {
                      QC.Console.error('Login => getMe èŽ·å–æ•°æ®å¤±è´¥' + t)
                    })
                : s(e)
            })
          : s(e),
    ...
    var c,
      o = function () {
        return (
          ...
          (function () {
            ...
            if ((e = q.get('__qc__k')) && ((t = e.split('=')), e.length && 2 != t.length))
              throw new Error('QQConnect -> cookie : __qc__k æ ¼å¼éžæ³•')
            p = (n && n[1]) || (t && t[1])
          })()
        )
      },
      h = (function () {
        ...
        var a,
          s,
          e = function (t) {
            C.error(t + ' : _getMeError'), window.callback({ error_description: t })
          },
          c = function (t) {
            ;(s = s || window.callback),
              t && c.cbPool.push(t),
              (window.callback = function (t) {
                if ((clearTimeout(i), t.openid)) {
                  var e,
                    ...
                    o = p
                  for (
                    C.log(' getMe => openId & accessToken ' + [n, o, a ? 'é€šè¿‡meæŽ¥å£' : 'é€šè¿‡æœ¬åœ°']);
                    (e = c.cbPool.shift());
              ...
              o()
                ? u
                  ...
                  : a ||
                    ...
                    (a.src = 'https://graph.qq.com/oauth2.0/me?access_token=' + p),
                    (a.onerror = function () {
                      e('meæŽ¥å£è¿”å›žæ ¼å¼é”™è¯¯')
                    }),
                    (t = document.getElementsByTagName('head')[0]) && t.appendChild(a),
    ...
    return (
      w.extend(t, {
        ...
        _onLoginBack: function (t, e, n) {
          t && e && ((d = t), (document.cookie = ['__qc__k=' + ['TC_MK', e].join('='), 'path=/'].join(';'))),
        ...
        fillUserInfo: function (t, e) {
          var n = _(t),
            t = [
              ...
              '<span class="qc_item logout"><a href="javascript:QC.Login.signOut();" style="margin-left:6px;">é€€å‡º</a></span>'
            ].join('')
  ...
  ;(g.init = function (o) {
    D = o = o || D || {}
    var t = g.Login._getTokenKeys()
    if (((R = o.appId), (F = o.redirectURI), t.openid))
      g.Login.getMe(function (t, e, n) {
        !~~n.error && (n.client_id <= 0 || n.client_id % 1e6 == o.appId % 1e6)
          ? ((R = n.client_id = o.appId || o.clientId || o.app_id || o.client_id || -1), g.api._ready && g.api._ready())
          : g.Console.error(n.error_description || 'appId/client_id ä¸åŒ¹é…')
      }, !0)
    else if ((f.invoke(), T.length && -1 < o.appId)) for (var e = 0; e < T.length; e++) T[e]()
  }),
  ...
  ;(A = t('appid')),
    (z = t('redirecturi')),
    A &&
      (g.Console.info('æ£€æµ‹åˆ°è‡ªåŠ¨åˆå§‹åŒ–å‚æ•°\nappId:' + A + '\nrUri:' + z),
      isNaN(A)
        ? g.Console.error('å‚æ•°appidé”™è¯¯')
        : z && 0 != z.indexOf('http')
        ? g.Console.error('å‚æ•°rediectURIé”™è¯¯')
